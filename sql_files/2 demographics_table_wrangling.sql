/* 
Here, we're going to extract the demographic information from the research_1_data_copy table. 
...
/*
There are blanks in the brgy column. These are people who declined to 
report their barangay information. Let's just turn them into nulls.
*/
...
/* 
There are ages that are beyond our constraints. I would consider these encoding 
errors and remove the zeros at the end of the numbers greater than 100. 
*/
...
/* 
As for the zero value in the age, we'll assume that the 
person didn't want to report their age. We'll keep it as is. 
*/
...
/* 
There are zeroes reported in the family_income. These are people who chose not 
to report their monthly family income. I want to turn them to NULLS so we don't 
get confused in the computations later. 
*/
...
/* 
There are those with zero income declared, which we turned to null earlier. 
However, the class column still reports them as "Poor". This is misrepresentation of the data. 
We need to turn class data to nulls if the reported family income is 0 or null. 
*/ 
