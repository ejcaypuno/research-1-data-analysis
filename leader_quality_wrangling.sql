# For the leadership qualities part of the questionnaire, the interpretation of the scores rely heavily on the questions tied to it. There isn't much structure to it. For us not to lose this context, and to save space, we're going to introduce a question code column beside our scores and make a separate table for the questions themselves. That way the questions don't repeat multiple times in the main table, thus saving us space and can just be joined as needed. 
...
#Checking if it's going to be usable as intended: 
SELECT
	*
